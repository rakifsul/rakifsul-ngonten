...
- [Cara Build Ollama dari Source Code dan Mencoba Menjalankannya](teks/1-Trik-LLM/Cara-Build-Ollama-dari-Source-Code-dan-Mencoba-Menjalankannya.md)
- [Cara Mencoba BitNet LLM dengan Menggunakan Web UI dan Docker](teks/1-Trik-LLM/Cara-Mencoba-BitNet-LLM-dengan-Menggunakan-Web-UI-dan-Docker.md)
- [Cara Mengatasi Ollama Macet saat Memproses Prompt](teks/1-Trik-LLM/Cara-Mengatasi-Ollama-Macet-saat-Memproses-Prompt.md)
- [Cara Skip Update NVidia Saat Upgrade Ubuntu](teks/1-Trik-LLM/Cara-Skip-Update-NVidia-Saat-Upgrade-Ubuntu.md)
- [Cerita Waktu Saya Ingin Coding Pakai LLM Lokal dengan VSCode di Ubuntu 24.04.2](teks/1-Trik-LLM/Cerita-Waktu-Saya-Ingin-Coding-Pakai-LLM-Lokal-dengan-VSCode-di-Ubuntu-24.04.2.md)
- [Membandingkan Hasil Benchmark Dua Nilai Batch Size pada Penggunaan llama bench dari llama.cpp](teks/1-Trik-LLM/Membandingkan-Hasil-Benchmark-Dua-Nilai-Batch-Size-pada-Penggunaan-llama-bench-dari-llama.cpp.md)
- [Membuat Bahasa Pemrograman Web yang Menggunakan Bahasa Manusia dengan LLM](teks/1-Trik-LLM/Membuat-Bahasa-Pemrograman-Web-yang-Menggunakan-Bahasa-Manusia-dengan-LLM.md)
- [Membuat CLI Cerdas yang Paham Command Bahasa Manusia](teks/1-Trik-LLM/Membuat-CLI-Cerdas-yang-Paham-Command-Bahasa-Manusia.md)
- [Memperbaiki Setting LM Studio agar Bisa Jalan Lagi](teks/1-Trik-LLM/Memperbaiki-Setting-LM-Studio-agar-Bisa-Jalan-Lagi.md)
- [Memperbaiki Stable Diffusion Versi OpenVINO yang Gagal Memuat Script OpenVINO](teks/1-Trik-LLM/Memperbaiki-Stable-Diffusion-Versi-OpenVINO-yang-Gagal-Memuat-Script-OpenVINO.md)
- [Menginstall Ollama dan Open WebUI di Ubuntu 24.04 tanpa Docker](teks/1-Trik-LLM/Menginstall-Ollama-dan-Open-WebUI-di-Ubuntu-24.04-tanpa-Docker.md)
- [Tutorial llama.cpp Seri 1 Perkenalan dan Prasyarat](teks/1-Trik-LLM/Tutorial-llama.cpp-Seri-1-Perkenalan-dan-Prasyarat.md)
- [Tutorial llama.cpp Seri 2 Installasi dan Setup](teks/1-Trik-LLM/Tutorial-llama.cpp-Seri-2-Installasi-dan-Setup.md)
- [Tutorial llama.cpp Seri 3 Build llama.cpp Konfigurasi Default](teks/1-Trik-LLM/Tutorial-llama.cpp-Seri-3-Build-llama.cpp-Konfigurasi-Default.md)
- [Tutorial llama.cpp Seri 4 Mencoba Temperature dan Top K](teks/1-Trik-LLM/Tutorial-llama.cpp-Seri-4-Mencoba-Temperature-dan-Top-K.md)
- [Tutorial llama.cpp Seri 5 Konversi Model ke GGUF dan Kuantisasinya](teks/1-Trik-LLM/Tutorial-llama.cpp-Seri-5-Konversi-Model-ke-GGUF-dan-Kuantisasinya.md)
- [Tutorial llama.cpp Seri 6 Kenapa Bash Begitu Menarik](teks/1-Trik-LLM/Tutorial-llama.cpp-Seri-6-Kenapa-Bash-Begitu-Menarik.md)
...
- [Aplikasi Catatan Terenkripsi Portable untuk Ubuntu](teks/2-Ubuntu/Aplikasi-Catatan-Terenkripsi-Portable-untuk-Ubuntu.md)
- [Aplikasi Self Hosted Terbaik Menurut RAKIFSUL Ngonten yang Layak Anda Coba](teks/2-Ubuntu/Aplikasi-Self-Hosted-Terbaik-Menurut-RAKIFSUL-Ngonten-yang-Layak-Anda-Coba.md)
- [Aplikasi Wikipedia Offline dan zim Viewer](teks/2-Ubuntu/Aplikasi-Wikipedia-Offline-dan-zim-Viewer.md)
- [Beberapa Kebiasaan Saya saat Baru Menyewa VPS](teks/2-Ubuntu/Beberapa-Kebiasaan-Saya-saat-Baru-Menyewa-VPS.md)
- [Bikin Docker Compose Sakti untuk Web Developers](teks/2-Ubuntu/Bikin-Docker-Compose-Sakti-untuk-Web-Developers.md)
- [Cara Auto Start Kiwix Serve Docker Ubuntu 24.04.2 jika ZIM Folder Ada di External Drive](teks/2-Ubuntu/Cara-Auto-Start-Kiwix-Serve-Docker-Ubuntu-24.04.2-jika-ZIM-Folder-Ada-di-External-Drive.md)
- [Cara Build dan Install metube Aplikasi Video Downloader](teks/2-Ubuntu/Cara-Build-dan-Install-metube-Aplikasi-Video-Downloader.md)
...
- [Cara Membuat Aplikasi Code Server jadi Portable di Ubuntu 24.04](teks/2-Ubuntu/Cara-Membuat-Aplikasi-Code-Server-jadi-Portable-di-Ubuntu-24.04.md)
- [Cara Membuat PHP Build Kemarin Menjadi Portable](teks/2-Ubuntu/Cara-Membuat-PHP-Build-Kemarin-Menjadi-Portable.md)
- [Cara Membuat Search Engine Pribadi dengan SearXNG](teks/2-Ubuntu/Cara-Membuat-Search-Engine-Pribadi-dengan-SearXNG.md)
- [Cara Mem Build Beberapa Versi PHP di Ubuntu](teks/2-Ubuntu/Cara-Mem-Build-Beberapa-Versi-PHP-di-Ubuntu.md)
- [Cara Mengaktifkan Create Link di Nautilus Ubuntu 24.04](teks/2-Ubuntu/Cara-Mengaktifkan-Create-Link-di-Nautilus-Ubuntu-24.04.md)
- [Cara Mengamankan Docker Container dengan UFW](teks/2-Ubuntu/Cara-Mengamankan-Docker-Container-dengan-UFW.md)
...
- [Mencoba Kembali untuk Install Mastodon dengan Docker](teks/2-Ubuntu/Mencoba-Kembali-untuk-Install-Mastodon-dengan-Docker.md)
- [Mencoba Menginstall Tiga Social Media Self Hosted dengan Docker](teks/2-Ubuntu/Mencoba-Menginstall-Tiga-Social-Media-Self-Hosted-dengan-Docker.md)
- [Mengatur SystemD Ubuntu dengan Mudah dengan SysD Manager](teks/2-Ubuntu/Mengatur-SystemD-Ubuntu-dengan-Mudah-dengan-SysD-Manager.md)
- [Script Nautilus Open Source untuk Berbagai Keperluan](teks/2-Ubuntu/Script-Nautilus-Open-Source-untuk-Berbagai-Keperluan.md)
- [Teknik Dasar Pengarsipan Web dengan Kiwix Zim dan Aplikasi Lainnya](teks/2-Ubuntu/Teknik-Dasar-Pengarsipan-Web-dengan-Kiwix-Zim-dan-Aplikasi-Lainnya.md)
- [Web Archiving Terstruktur Tanpa Menggunakan Docker](teks/2-Ubuntu/Web-Archiving-Terstruktur-Tanpa-Menggunakan-Docker.md)
